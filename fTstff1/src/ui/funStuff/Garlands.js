...
const KeygrameGarlands = keyframes`
  0% {
    fill-opacity: 0.25;
  }
  100% {
...
const StyledGarlands = styled.div`
  ...
  & .bulb {
    ...
    -webkit-animation-name: ${KeygrameGarlands};
    -webkit-animation-iteration-count: infinite;
    -webkit-animation-timing-function: ease-in-out;
    -webkit-animation-direction: alternate;
    animation-name: ${KeygrameGarlands};

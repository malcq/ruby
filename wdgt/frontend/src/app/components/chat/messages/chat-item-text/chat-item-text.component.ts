...
@Component({
  selector: 'app-chat-item-text',
  templateUrl: './chat-item-text.component.html',
  styleUrls: ['./chat-item-text.component.css'],
  animations: [
    messageAnimationBot,
    loadingMessageAnimation,
  ]
})
export class ChatItemTextComponent implements OnInit, ChatBaseComponent {
  @Input() data: any = {text: ''};
...
messageComponentResolver.addComponent('app-chat-item-text', ChatItemTextComponent);
